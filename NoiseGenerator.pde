// Credit Michael Morton, https://gist.github.com/mmorton/f2fd02c9171c6ad67995
// Slightly modified to work in processing, also converted all doubles to floats because everything else uses floats. doubles suck lol
// Mostly Michael Morton tho.
public class OpenSimplexNoise {
  private static final float STRETCH_CONSTANT_3D = -1.0 / 6;
  private static final float SQUISH_CONSTANT_3D = 1.0 / 3;
